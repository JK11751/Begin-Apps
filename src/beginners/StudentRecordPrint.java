...
public class StudentRecordPrint{
	...
	public static void main(String[] args) {
		...
		exit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame,"Are you sure you want to exit!", "The System",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
				{
